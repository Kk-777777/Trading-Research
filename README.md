...
## Key Finding
Japan's near-total dependence on Middle East oil (~97% imported, ~95% via Hormuz) means the supply shock is structural, not transitory — BoJ's mandate shift from deflation escape to price stability means cost-push inflation now demands a policy response, not patience. Market currently prices 60bps of hikes; Taylor Rule implies 110bps — a 50bps mispricing that creates asymmetric downside for USD/JPY.
...
Short gold thesis based on regime analysis of the gold-rate relationship 
during the Hormuz Strait crisis.

## Key Finding
Interest rate sensitivity of gold amplified 15× in the recent regime 
(2021–2026) vs. long-term sample — market mispricing creates 
asymmetric downside risk.

## Trade Recommendation
Short GC futures / Buy GLD put on rallies toward $4,950–$5,000 resistance.
